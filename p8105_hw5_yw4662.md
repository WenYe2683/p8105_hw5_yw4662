...
As the true mean grows from 0 to 6, the power increases monotonically
from roughly 5% to nearly 100%. Larger effect sizes make it easier to
reject the null.
...
The raw homicide dataset from the Washington Post contains one row per
homicide case across 50 large U.S. cities, with variables including
victim demographics (name, age, sex, race), location (city, state,
latitude, longitude), year, and disposition.
...
![](p8105_hw5_yw4662_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
